...
// Username: indian9958
// Password: nCXZ1sWf4cgnTIgw

// DB_Name: job-portal-project
// Username: indian9958
// Password: 3Na8yJQOBP8jtKhD
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@job-portal-project.vaa20.mongodb.net/?retryWrites=true&w=majority&appName=job-portal-project`;
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@job-portal-project.vaa20.mongodb.net/?retryWrites=true&w=majority&appName=job-portal-project`;
...
async function run() {
    try {
        ...
        // create db
        const db = client.db("job-portal-project");
